/*  ==========================================================================
  ...
  /*  ==========================================================================
    ...
    function navBtnClosedOver() {
      ...
      navIconTL.set('.burger__stroke-over', { stroke: "#CE9461", drawSVG: 0 })
           .to('.burger__plus', 0.3, { fill: '#4F0E0E', rotation: 0, ease: Power4.easeInOut })
    ...
    function navBtnClosedOut() { 
      ...
      navIconTL.to('.burger__stroke-over', 0.4, { drawSVG: 0, ease: Power4.easeInOut })
           .to('.burger__plus', 0.3, { fill: '#4F0E0E', rotation: 0, ease: Power4.easeInOut }, 0);
    }
  
    function navBtnOpenOver() {
  
      var navIconTL = new TimelineMax();
      navIconTL.to('.burger__plus', 0.3, { fill: '#4F0E0E', rotation: 135, ease: Power4.easeInOut, transformOrigin: "center center" })
